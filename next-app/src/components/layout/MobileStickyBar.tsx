...
export const MobileStickyBar: React.FC = () => {
  ...
  const finalWaUrl =
    waUrl && waUrl !== '#' && waUrl !== '#contacto'
      ? waUrl
      : getWhatsAppChatUrl(
          business.whatsappPhone,
          '¡Hola Variedades Isaías! Me gustaría cotizar prendas personalizadas desde mi móvil.'
        );

  const handleWhatsAppClick = () => {
    trackWhatsAppClick('mobile_sticky_bar', { totalUnits });
  };
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto flex flex-col gap-1.5">
        ...
        {/* Primary Action: Direct WhatsApp Quote */}
        <a
          href={finalWaUrl}
          target="_blank"
