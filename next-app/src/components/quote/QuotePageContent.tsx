      ...
      {quoteItems.length === 0 ? (
        ...
        <div className="bg-[#0b0b0e] border border-white/10 rounded-xs p-12 sm:p-20 text-center flex flex-col items-center gap-6 shadow-2xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link
              href="/catalogo"
              className="font-sans text-xs uppercase tracking-[0.14em] bg-[#C8A96E] hover:bg-[#dbbe82] text-[#070708] font-bold px-8 py-3.5 rounded-xs transition-all shadow-xl"
            >
              Explorar Catálogo →
            </Link>
            <Link
              href="/servicios"
              className="font-sans text-xs uppercase tracking-[0.14em] bg-[#141419] hover:bg-[#1c1c24] border border-white/15 text-[#F4F1EA] px-6 py-3.5 rounded-xs transition-all font-semibold"
            >
            ...
            >
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="bg-[#141419] border border-white/15 focus:border-[#C8A96E] text-[#F4F1EA] p-3 rounded-xl outline-none text-xs"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="bg-[#141419] border border-white/15 focus:border-[#C8A96E] text-[#F4F1EA] p-3 rounded-xl outline-none resize-none text-xs"
                />
              </div>

              {/* Order Summary Numbers */}
              <div className="p-4 bg-black/60 border border-white/10 rounded-xl flex flex-col gap-2 my-1 font-sans text-xs">
                ...
                {estimatedTotal !== undefined && estimatedTotal > 0 && (
                  <div className="flex justify-between border-t border-white/10 pt-2 font-mono">
                    <span className="text-[#A0A0A5] font-sans">Estimado Referencial:</span>
              ...
              <div className="flex flex-col gap-3 pt-2">
                {isConfigured ? (
                  ...
                  <button
                    type="submit"
                    className="w-full font-sans text-xs uppercase tracking-wider bg-[#C8A96E] hover:bg-[#dbbe82] text-[#070708] font-bold py-4 px-6 rounded-xl shadow-xl transition-all cursor-pointer text-center"
                  >
                    Enviar Cotización al Taller
                  </button>
                )}

                <p className="text-center text-[11px] text-[#A0A0A5]">
