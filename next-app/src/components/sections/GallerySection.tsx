...
const LOOKBOOK_PROJECTS: LookbookProject[] = [
  {
    ...
    productType: 'Piel de durazno suave · Crop Fit',
    technique: 'Estampado DTF',
  ...
  {
    id: 'project-03',
    title: 'Camiseta Deportiva Retro',
    productType: 'Poliéster DryFit transpirable',
    technique: 'Sublimación 4K & bordado',
    href: '/catalogo/ropa/camiseta-qatar-estampada',
    image: '/assets/img-7.jpg',
  },
  {
    id: 'project-04',
    title: 'Conjunto Infantil Reflectivo',
    productType: 'Algodón suave para niños',
    technique: 'Estampado reflectivo de alta duración',
    href: '/catalogo/ropa/conjunto-infantil-reflectivo',
