...
const LOOKBOOK_PROJECTS: LookbookProject[] = [
  {
    ...
    productType: 'Silueta Ajustada Piel de Durazno 220g',
    technique: 'Estampado DTF Suave al Tacto',
    context: 'Línea contemporánea · Valledupar',
    aspect: 'aspect-[3/4]',
  ...
  },
  {
    id: 'project-02',
    tag: 'PROJECT 02',
    title: 'Polo Institucional Bordada',
    productType: 'Algodón Piqué & Cuello Tejido',
    technique: 'Bordado Computarizado en Relieve',
    context: 'Dotación corporativa en exteriores',
    aspect: 'aspect-[16/11]',
  ...
  },
  {
    id: 'project-03',
    tag: 'PROJECT 03',
    title: 'Camiseta Colombia Retro',
    productType: 'Indumentaria Deportiva DryFit',
    technique: 'Sublimación 4K & Escudo Bordado',
    context: 'Edición deportiva especial Valledupar',
    aspect: 'aspect-[16/11]',
  ...
  },
  {
    id: 'project-04',
    tag: 'PROJECT 04',
    title: 'Cápsula Infantil DTF',
    productType: 'Algodón Peinado 100% Infantil',
    technique: 'Estampado DTF de Alta Resistencia',
