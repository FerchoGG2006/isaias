  ...
  return (
    <section id="contacto" className="wrap py-10 sm:py-14 border-t border-white/10 scroll-mt-24">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-6">
        ...
        {/* Clean CTAs */}
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4 w-full max-w-lg font-mono text-xs">
          {isConfigured ? (
            <a
              href={url}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto uppercase tracking-[0.2em] bg-[#25D366] hover:bg-[#20bd5a] text-[#070708] font-bold px-8 py-4 rounded-xs shadow-xl transition-all text-center flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto uppercase tracking-[0.2em] bg-[#C8A96E] hover:bg-[#B8985D] text-[#0C0D10] font-bold px-8 py-4 rounded-xs shadow-xl transition-all text-center cursor-pointer"
            >
          ...
          <Link
            href="/catalogo"
            className="w-full sm:w-auto uppercase tracking-[0.2em] text-[#F4F1EA] hover:text-[#C8A96E] bg-[#141419] hover:bg-[#1C1C24] border border-white/15 px-8 py-4 rounded-xs transition-all text-center font-medium"
          >
            Explorar Catálogo
          </Link>
        </div>
        ...
        {/* Footnote */}
        <div className="pt-6 border-t border-white/10 w-full flex flex-wrap items-center justify-center gap-6 text-xs text-[#8A8A92] font-mono">
