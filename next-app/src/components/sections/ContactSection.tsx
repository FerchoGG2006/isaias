...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contacto" className="wrap py-14 sm:py-20 border-t border-white/10 scroll-mt-24">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-6">
        
        {/* Headline */}
        <h2 className="font-sans font-bold text-3xl sm:text-5xl lg:text-6xl text-[#F4F1EA] tracking-tight leading-tight">
          ¿Qué vamos a crear juntos?
        </h2>

        {/* Supporting Text */}
        <p className="font-sans text-base sm:text-lg text-[#8A8A92] max-w-xl leading-relaxed font-light">
