      ...
      <main className="min-h-screen bg-[#0C0D10] text-[#F4F1EA] pt-12 pb-32">
        ...
        <section className="wrap mb-12 sm:mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-8 border-b border-white/10">
            <div>
              <div className="flex items-baseline gap-4 mb-3">
                ...
                <span className="font-serif italic text-sm text-[#8A8A92]">Colección 2026</span>
              </div>
            ...
            {/* Contador y especificaciones del taller */}
            <div className="flex flex-col lg:items-end text-left lg:text-right font-sans text-xs uppercase tracking-[0.2em] text-[#8A8A92]">
              ...
              <span className="text-[10px] text-[#8A8A92]/70 mt-0.5">
                DTF 160°C · Spandex 220g · Wilcom 3D
              </span>
            </div>
          </div>
          ...
          <div className="pt-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <nav
              className="flex items-center gap-4 sm:gap-8 overflow-x-auto pb-2 scrollbar-none text-xs uppercase font-sans tracking-[0.18em]"
              ...
              {EDITORIAL_FILTERS.map((f) => {
                ...
                return (
                  <button
                    ...
                    className={`relative py-2 transition-colors duration-300 cursor-pointer whitespace-nowrap flex items-center gap-2 ${
                      isActive
                  ...
                  >
                    <span>{f.label}</span>
                    <span className={`font-mono text-[10px] ${isActive ? 'text-[#C8A96E]' : 'text-[#8A8A92]/60'}`}>
                      [{count}]
                    </span>
                    {isActive && (
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 text-xs font-sans text-[#8A8A92]">
            <div className="flex flex-col gap-1 max-w-md">
              ...
              <p className="font-light leading-relaxed">
                Prendas confeccionadas bajo demanda con curado térmico de 160 °C, bordado matricial Wilcom y sublimación 4K en nuestro taller de Valledupar.
              </p>
            </div>
