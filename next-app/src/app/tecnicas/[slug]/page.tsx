            ...
            <div className="lg:col-span-6 flex flex-col justify-between">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
                <a
                  ...
                  className="w-full sm:w-auto bg-[#C8A96E] hover:bg-[#dbbe82] text-[#0C0D10] font-sans font-bold text-xs uppercase tracking-wider px-8 py-4 rounded-xl shadow-xl transition-all hover:scale-105 flex items-center justify-center gap-2.5"
                >
