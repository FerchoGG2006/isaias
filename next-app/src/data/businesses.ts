...
export const BUSINESSES: Record<string, Business> = {
  isaias: {
    ...
    department: 'Cesar',
    country: 'Colombia',
    address: 'Calle 16 # 19A - 45, Valledupar, Cesar · Colombia',
    streetAddress: 'Calle 16 # 19A - 45',
    responseTimePromise: 'Menos de 15 minutos en horario hábil',
    schedule: 'Lunes a Sábado: 8:00 AM – 6:00 PM',
    googleMapsUrl: 'https://maps.google.com/?q=Calle+16+%23+19A+-+45,+Valledupar,+Cesar,+Colombia',
